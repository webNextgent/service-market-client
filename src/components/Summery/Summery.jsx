...
export default function Summary({
    ...
    return (
        <>
            ...
            {/* MOBILE BOTTOM BAR */}
            <div className="lg:hidden fixed bottom-0 left-0 w-full bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.08)] border-t border-gray-200 px-3 py-2 flex items-center justify-between">
                <div onClick={() => setOpen(true)} className="cursor-pointer select-none z-50">
